(function ($) {
                                ...
                                if ((['image', 'video', 'audio', 'astext'].indexOf(item.format) > -1 || item.data.thumbnail) && f.isFileReaderSupported() && !readerSkip && (item.appended || n.thumbnails.startImageRenderer || forceRender)) {
                                    ...
                                    var load = function (data, fromReader) {
                                        ...
                                        if (n.thumbnails.canvasImage) {
                                            $('.fileuploader-input').css("background", "url('" + src + "') center center / cover no-repeat");
    ...
    $.fn.fileuploader.languages = {
        ...
        en: {
            ...
            feedback: function (options) {
                return 'No ' + (options.limit == 1 ? 'file' : 'files') + ' chosen'
            },
            feedback2: function (options) {
    ...
    $.fn.fileuploader.defaults = {
        ...
        thumbnails: {
            ...
            onItemRemove: function (html) {
                ...
                $('.fileuploader-input').css("background", "");
                // $(".fileuploader-input").css("display", "block");
            },
            onImageLoaded: null
        },
        editor: false,
