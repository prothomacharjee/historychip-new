                            ...
                            @if ($detail)
                                <p class="text-white mb-0 softsoutce-top-banner-paragraph">
                                    <span class="far fa-user meta-icon">
                                        ...
                                        @else
                                            <a
                                                href="{{ url('authors/' . $stories->author_id . '-' . Str::slug($stories->author_details->name)) }}">A
                                ...
                                <div class=" text-center d-flex justify-content-center">
                                    <button class="softsource-btn-social facebook" title="Share On Facebook">
                                        <img style="width:100%;" class="img-fluid"
                                            src="{{ asset('frontend/images/social-media/facebook.png') }}"
                                            alt="Facebook Share">
                                    </button>
                                    <button class="softsource-btn-social twitter" title="Share On Twitter">
                                        <img style="width:100%;" class="img-fluid"
                                            src="{{ asset('frontend/images/social-media/twitter.png') }}"
                                            alt="Twitter Share">
                                    </button>
                                    ...
                                    <button class="softsource-btn-social mail" title="Send with Email">
                                        <img style="width:100%;" class="img-fluid"
                                            src="{{ asset('frontend/images/social-media/mail.png') }}"
                                            alt="Telegram Share">
                                    </button>
                                </div>
                            </div>
                                                            ...
                                                            <div class="bg-light p-2 border-bottom">
                                                                <div class="d-flex flex-row align-items-center">
                                                                    <img class="rounded-circle"
                                                                        src="{{ !empty(Auth::user()->image) ? asset(Auth::user()->image) : asset('frontend/images/web_img/user4.jpg') }}"
                                                                        width="40">
                                            ...
                                            <div class="row align-items-center">
                                                @if (Auth::check())
                                                    <div class="col-lg-12 col-md-12 mb-2">
                                                        <p
                                                            ...
                                                            written from the best recollections of the writers. All of our
                                                            memories will
                                                    ...
                                                    <div class="col-lg-12 col-md-12">
                                                        <div class="bg-light p-2">
                                                            ...
                                                            <div class="mt-2 text-end">
                                                                <button
                                                                    class="softsource-btn btn-primary btn-sm shadow-none"
                                                ...
                                                @else
                                                    <div class="col-lg-12 col-md-12">
                                                        <p
                                                            style="font-size: 10px; text-align:justify; font-weight:700px; color: #ca0b0b">
                                                            To leave a comment, please <a
                                                                href="{{ route('login') }}">Signin</a> or <a
