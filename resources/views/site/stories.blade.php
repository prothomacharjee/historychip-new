    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8  m-auto">
                <div class="story-feature story-single blog-thumbnail  wow move-up animated" style="visibility: visible;">
                    @php
            ...
            <div class="col-lg-8  m-auto">
                <video style="width: 80%;  margin-left: 10%; margin-top: 25px; margin-right: 10%" controls controlsList="nodownload">
            ...
            @else
            <div class="col-lg-8  m-auto">
                <audio style="width: 80%; height: 40px; margin-left: 10%; margin-top: 25px; margin-right: 10%" controls controlsList="nodownload">
                    <source src="{{ $stories->audio_video_path }}">
                ...
                <div class="text-center" style="color:#778B91">
                    ...
                    <div class=" text-center d-flex justify-content-center">
                        <button class="softsource-btn-social facebook" title="Share On Facebook">
                            <img style="width:100%;" class="img-fluid" src="{{ asset('frontend/images/social-media/facebook.png') }}" alt="Facebook Share">
                        </button>
                        <button class="softsource-btn-social twitter" title="Share On Twitter">
                            <img style="width:100%;" class="img-fluid" src="{{ asset('frontend/images/social-media/twitter.png') }}" alt="Twitter Share">
                        </button>
                        <button class="softsource-btn-social linkedin" title="Share On LinkedIn">
                            <img style="width:100%;" class="img-fluid" src="{{ asset('frontend/images/social-media/linkedin.ico') }}" alt="LinkedIn Share">
                        </button>
                        <button class="softsource-btn-social whatsapp" title="Share On WhatsApp">
                            <img style="width:100%;" class="img-fluid" src="{{ asset('frontend/images/social-media/whatsapp.png') }}" alt="WhatsApp Share">
                        </button>
                        <button class="softsource-btn-social telegram" title="Share On Telegram">
                            <img style="width:100%;" class="img-fluid" src="{{ asset('frontend/images/social-media/telegram.png') }}" alt="Telegram Share">
                        </button>
                        <button class="softsource-btn-social mail" title="Send with Email">
                            <img style="width:100%;" class="img-fluid" src="{{ asset('frontend/images/social-media/mail.png') }}" alt="Telegram Share">
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style="background: transparent !important; color:#778b91 !important">
                                Read Comments
                            </button>
                        </h2>
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                @php
                                $commenter = $comment->commentator;
                                @endphp
                                <div class="row align-items-center ">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="bg-light p-2 border-bottom">
                                            <div class="d-flex flex-row align-items-center">
                                                <img class="rounded-circle" src="{{ !empty(Auth::user()->image) ? asset(Auth::user()->image) : asset('frontend/images/web_img/user4.jpg') }}" width="40">
                                                <p class="ms-3 mb-0">{{ $commenter->name }}</p>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingTwo">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="background: transparent !important; color:#778b91 !important">
                                Write Comment
                            </button>
                        </h2>
                            ...
                            <div class="accordion-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-12 col-md-12 mb-2">
                                        <p style="font-size: 10px; text-align:justify; font-weight:700px; color: #ca0b0b">
                                            Note: Please be respectful of writers on History Chip and
                                            refrain from criticism. Remember the stories on History Chip are
                                            written from the best recollections of the writers. All of our memories will
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="bg-light p-2">
                                            <div class="d-flex flex-row align-items-start">
                                                <img class="rounded-circle m-2" src="{{ !empty(Auth::user()->image) ? asset(Auth::user()->image) : asset('frontend/images/web_img/user4.jpg') }}" width="40">
                                            ...
                                            <div class="mt-2 text-end">
                                                <button class="softsource-btn btn-primary btn-sm shadow-none" type="button" id="commentpost">Post
                                                    Comment</button>
                                                <button class="softsource-btn btn-outline-primary btn-sm ms-3 shadow-none" type="button" id="commentcancel">Cancel</button>
                                            </div>
                                        </div>
                                    </div>
                                    @else
                                    <div class="col-lg-12 col-md-12">
                                        <p style="font-size: 10px; text-align:justify; font-weight:700px; color: #ca0b0b">
                                            To leave a comment, please <a href="{{route('login')}}">Signin</a> or <a href="{{route('register')}}">Register</a>.
                                        </p>
                                    </div>
                                    @endif
                                </div>
                ...
                <div class="softsource-story-item-div">
                    <div class="softsource-story-item-image text-center">
                        <a href="{{ url($story->url) }}">
                            <img class="img-fluid" src="{{ asset($headerImage) }}" alt="{{ $story->header_image_alt_text }}" style="width: 370px;">
                        </a>
                    </div>
                    <div class="softsource-story-item-details">
                        ...
                        <div style="width: 100%; height: 33px;">
                            ...
                            <video style="width: 96%; height: 100px; margin-left: 2%; margin-right: 2%" controls controlsList="nodownload">
                                <source src="{{ $story->audio_video_path }}">
                                Your browser does not support the audio element.
                            </video>
                            @else
                            <audio style="width: 96%; height: 40px; margin-left: 2%; margin-right: 2%" controls controlsList="nodownload">
                                <source src="{{ $story->audio_video_path }}">
                                Your browser does not support the audio element.
                            </audio>
                            @endif
                        ...
                        <div class="softsource-story-btn-text">
                            <a href="{{ url($story->url) }}">Read more <i class="ml-1 button-icon fas fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
