        ...
        <div class="container">
            ...
            <div class="col-lg-12">
                <div class="text-center  ">
                    <ul class="nav justify-content-center softsource-my-story-tab-wrap">
                        <li class="tab__item nav-item">
                            <a data-toggle="tab" href="#tab_published" class="nav-link active">Published Stories</a>
                        </li>
                        <li class="tab__item nav-item">
                            <a data-toggle="tab" href="#tab_submitted" class="nav-link">Submitted Stories</a>
                        </li>
                        <li class="tab__item nav-item">
                            <a data-toggle="tab" href="#tab_draft" class="nav-link">Draft Stories</a>
                        </li>
                        <li class="tab__item nav-item">
                            <a data-toggle="tab" href="#tab_reject" class="nav-link">Rejected Stories</a>
                        </li>
                    </ul>
                </div>
                <div class="tab-content ht-tab__content">
                    <div id="tab_published" class="tab-pane fade active show">
                    ...
                    <div id="tab_submitted" class="tab-pane fade">
                        <div class="tab-history-wrap section-space--mt_40">
                    ...
                    <div id="tab_draft" class="tab-pane fade">
                        <div class="tab-history-wrap section-space--mt_40">
                    ...
                    <div id="tab_reject" class="tab-pane fade">
                        <div class="tab-history-wrap section-space--mt_40">
