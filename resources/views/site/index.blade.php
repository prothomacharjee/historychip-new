...
<div class="softsource-index-section1 position-relative">
    ...
    <div class="position-absolute top-50 text-end softsource-home-text-over-video-div">
        <h1 class="text-white text-end softsource-firstline-header">The <span class="softsource-firstline-header-inside">story</span> of our world is not complete until you add your
            ...
            <div class="col-md-12 col-xxl-12 col-xl-12 col-lg-12 col-12 col-sm-12 mx-auto d-flex softsource-home-daily-prompt text-center">
                ...
                <div class="softsource-home-daily-prompt-add-story">
                    <div class="softsource-home-daily-prompt-add-story-link">
                        <a title="Add with Audio" href="https://www.historychip.com/submitastory?type=audio"><i class="fa fa-music" aria-hidden="true"></i></a>
                        <a title="Add with Video" href="https://www.historychip.com/submitastory?type=audio"><i class="fa fa-video" aria-hidden="true"></i></a>
                        <a title="Add Only Text" href="https://www.historychip.com/submitastory?type=text" class="music"><i class="fa fa-file" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <form class="softsource-port-form d-flex" method="GET" action="">
                    <select class="form-control softsource-custom-select story-category-select2" name='category_id' id="category_id" required="">
                    ...
                    <button class="softsource-btn softsource-port-cust-btn"><i class="flaticon-magnifying-glass"></i><span>Go</span></button>
                </form>
                    ...
                    <div class="col-lg-4 col-md-6 mt-0">
                        ...
                        <div class="softsource-single-blog-item blog-grid">
                            ...
                            <div class="post-feature softsource-blog-thumbnail">
                                <a href="{{ url($blog->url) }}">
                                    <img class="img-fluid" src="{{ asset($blog_banner) }}" alt="{{ $blog->blog_banner_alt_text }}" style="width: 370px;">
                                </a>
                            </div>
                            <!-- Post Feature End -->
                            <!-- Post info Start -->
                                ...
                                <div class="btn-text">
                                    <a href="{{ url($blog->url) }}">Read more
                                        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M10 24H38" stroke="#3D5762" stroke-width="0.7" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M30 32L38 24" stroke="#3D5762" stroke-width="0.7" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M30 16L38 24" stroke="#3D5762" stroke-width="0.7" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </a>
                                </div>
                            </div>
