...
<div class="softsource-index-section1 position-relative">
    ...
    <div class="position-absolute top-50 text-end softsource-home-text-over-video-div">
        <h1 class="text-white text-end softsource-firstline-header">The <span class="softsource-firstline-header-inside">story</span> of our world is not complete until you add your <span class="softsource-firstline-header-inside">story</span></h1>
    </div>
    ...
    <div class="container">
                    ...
                    <div class="col-lg-4 col-md-6 mt-0">
                        ...
                        <div class="softsource-single-blog-item blog-grid">
                            ...
                            <div class="post-feature softsource-blog-thumbnail">
                                <a href="#">
                                    <img class="img-fluid" src="{{ asset('frontend/images/web_img/demo.jpg') }}" alt="Header Image" style="width: 370px;">
                                </a>
                            </div>
                            <!-- Post Feature End -->
                            <!-- Post info Start -->
        ...
        <div class="row mt-3">
            <div class="col-12 text-center">
                <button class="softsource-btn softsource-port-cust-btn"><i class="flaticon-magnifying-glass"></i><span>READ MORE STORIES</span></button>
            </div>
        </div>
    </div>
