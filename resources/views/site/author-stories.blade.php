            ...
            <div class="text-center  ">
                <ul class="nav nav-tabs justify-content-center softsource-my-story-tab-wrap" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" data-bs-toggle="tab" href="#tab_published" role="tab" aria-selected="true">
                            <div class="tab-title">Published Stories</div>
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" data-bs-toggle="tab" href="#tab_submitted" role="tab" aria-selected="false">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" data-bs-toggle="tab" href="#tab_reject" role="tab" aria-selected="false">
                        <div class="tab-title">Rejected Blogs</div>
                        </a>
                    </li>
                </ul>
            </div>
