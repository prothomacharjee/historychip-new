            ...
            <div class="softsource-register_div">
                ...
                <form class="mt-3" method="POST" id="register_form" action="{{ route('register.submit') }}" class="captcha-form">
                    ...
                    <div class="form-group">
                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="name" required autofocus placeholder="Name *">
                        @error('name')
                    ...
                    <div class="form-group">
                        <input id="pen_name" type="text" class="form-control @error('pen_name') is-invalid @enderror" name="pen_name" value="{{ old('pen_name') }}" required autofocus autocomplete="pen_name" placeholder="Pen Name - Your stories will appear under this name *">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            <input id="state" type="text" class="form-control @error('state') is-invalid @enderror" name="state" value="{{ old('state') }}" placeholder="State *" autocomplete="state">
                        ...
                        <div class="col">
                            <input id="country" type="text" class="form-control @error('country') is-invalid @enderror" name="country" value="{{ old('country') }}" placeholder="Country *" autocomplete="country">
                    ...
                    <div class="form-group">
                        <textarea id="bio" class="form-control resize-none" name="bio" rows="5" maxlength="400" placeholder="Tell readers a bit about yourself (Max 400 words)..."></textarea>
                    </div> <!-- / .form-group (bio) -->

                    <div class="form-group">
                        <div class="checkbox">
                            <input type="checkbox" id="toggle-partner"><label for="toggle-partner">Are You Willing to Join with Our Partner</label>
                        </div>
                        <select class="form-control d-none" id="org_id" name="org_id">
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" id="sixteen" name="sixteen" value="sixteen" required><label for="sixteen" class="softsource-register-terms-condition">I'm at least 16 years or older
                        </label><br />
...
<script>
    $(document).ready(function() {
        $('#toggle-partner').on('click', function() {
            $('#org_id').slideToggle('slow', 'swing');
        });
    });
</script>
