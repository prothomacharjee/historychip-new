            ...
            <div class="row">
                <div class="offset-lg-3 col-sm-10 col-md-8 col-lg-6 col-12 m-auto">
                    <div class="my-5">
                        ...
                        <form method="POST" action="{{ route('quick-register.submit') }}" id="login-form" class="captcha-form">
                            @csrf
                            <div class="form-group">
                                <label for="email" class="col-md-4 col-form-label">Enter Your Email <span
                            ...
                            <input type="submit" value="Quick Register" id="login" class="softsource-submit_btn">
