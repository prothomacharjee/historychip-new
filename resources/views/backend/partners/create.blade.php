                ...
                <div class="card-body">
                    <div class="p-4 border rounded">
                        <form class="row g-3 needs-validation" method="post" novalidate action="{{ route('admin.partners.store') }}" id="partner_form" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <label for="banner" class="form-label">Banner (Max - 2MB , Accepted - Jpg, Png, Svg, Jpeg, WebP) </label>
                                <input class="form-control file-uploader" name="banner" id="banner" type="file" accept=".png,.jpg,.jpeg,.svg, .webp" maxFileSize="2MB" onchange="FileUploaderValidation(this, 2, ['image/png', 'image/jpeg', 'image/svg', 'image/webp'], 'selected-file-banner', 25)" />
                            ...
                            <div class="col-md-12">
                                <label for="partner_type_id" class="form-label">Partner Type</label>
                                <select required name="partner[partner_type_id]" id="partner_type_id" class="form-control select2">
                            ...
                            <div class="col-md-6">
                                <label for="logo" class="form-label">Logo (Max - 1MB , Accepted - Jpg, Png, Svg, Jpeg, WebP) </label>
                                <input class="form-control file-uploader" name="logo" id="logo" type="file" accept=".png,.jpg,.jpeg,.svg, .webp" maxFileSize="1MB" onchange="FileUploaderValidation(this, 1, ['image/png', 'image/jpeg', 'image/svg', 'image/webp'], 'selected-file-logo', 25)" />
                                <div id="file-error" class="form-text text-danger"></div>
                                @error('logo')
                                <div id="validationContentFeedback" class="invalid-feedback">{{ $message }}
                                </div>
                            ...
                            <div class="col-md-6 text-center">
                                <div class="selected-file-logo">
                                    ...
                                    <img src="{{ $partner->logo }}" alt="{{ $partner->logo }}" class="w-25">
                                    @else
                                    <img src="{{ asset('backend/images/custom/no-image-icon.png') }}" alt="" class="w-25">
                                    @endif
                                    @endif
