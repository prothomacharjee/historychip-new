...
@section('content')
                    ...
                    <div class="card-body">
                        <div class="p-4 border rounded">
                            <form class="row g-3 needs-validation" novalidate
                                action="{{ route('admin.story-categories.store') }}" method="post">
                                @csrf
                                <input type="hidden" name="id" id="id" value="" />
                                <div class="col-md-12">
                                    <label for="name" class="form-label">Name <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" placeholder="A unique category name" required
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea minlength="3" maxlength="191" rows="5" class="form-control @error('description') is-invalid @enderror"
                                        id="description" name="description" placeholder="Write your Description here"
                                        aria-describedby="validationDescriptionFeedback">{{ old('description') }}</textarea>
                                    <div class="valid-feedback">Looks good!</div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class="form-select @error('level') is-invalid @enderror" id="level"
                                        name="level" required aria-describedby="validationLevelFeedback">
                                ...
                                <div class="col-md-12 parent_category_div" style="display:none">
                                    <label for="parent_id" class="form-label">Parent Category <span
                                            class="text-danger">*</span></label>
                                    <select class="form-select @error('parent_id') is-invalid @enderror softsource-select2"
                                        id="parent_id" name="parent_id" aria-describedby="validationParentCatFeedback">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs nav-primary" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" data-bs-toggle="tab" href="#base_category" role="tab"
                                    aria-selected="true">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" data-bs-toggle="tab" href="#level_1_cat" role="tab"
                                    aria-selected="false">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" data-bs-toggle="tab" href="#level_2_cat" role="tab"
                                    aria-selected="false">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" data-bs-toggle="tab" href="#level_3_cat" role="tab"
                                    aria-selected="false">
                                    <div class="d-flex align-items-center">
                        ...
                        <div class="tab-content py-3">
                            <div class="tab-pane fade show active" id="base_category" role="tabpanel">
                                <div class="table-responsive p-4 border rounded">
                                    <table id="dt_story_base_category" class="table table-striped table-bordered data-tables"
                                        style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>SL</th>
                            ...
                            <div class="tab-pane fade" id="level_1_cat" role="tabpanel">
                                <div class="table-responsive p-4 border rounded">
                                    <table id="dt_story_level_1_category" class="table table-striped table-bordered data-tables"
                                        style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>SL</th>
                            ...
                            <div class="tab-pane fade" id="level_2_cat" role="tabpanel">
                                <div class="table-responsive p-4 border rounded">
                                    <table id="dt_story_level_2_category" class="table table-striped table-bordered data-tables"
                                        style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>SL</th>
                            ...
                            <div class="tab-pane fade" id="level_3_cat" role="tabpanel">
                                <div class="table-responsive p-4 border rounded">
                                    <table id="dt_story_level_3_category" class="table table-striped table-bordered data-tables"
                                        style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>SL</th>
    ...
    <script>
        $(document).ready(function() {
            //Category
            $("#dt_story_base_category").DataTable({
                "processing": true,
                "serverSide": true,
            ...
            $("#dt_story_level_1_category").DataTable({
                "processing": true,
                "serverSide": true,
            ...
            $("#dt_story_level_2_category").DataTable({
                "processing": true,
                "serverSide": true,
            ...
            $("#dt_story_level_3_category").DataTable({
                "processing": true,
                "serverSide": true,
