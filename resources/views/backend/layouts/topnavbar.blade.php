    ...
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand">
            ...
            <div class="top-menu-left d-none d-lg-block">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" href="app-fullcalender.html" title="Calender"><i class='bx bx-calendar'></i></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="app-to-do.html" title="To Do List"><i class='bx bx-check-square'></i></a>
                    </li>
                </ul>
            </div>
