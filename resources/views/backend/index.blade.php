...
@section('content')
    ...
    <script src="{{ asset('backend/plugins/highcharts/js/highcharts.js?q=' . time()) }}"></script>
    <script src="{{ asset('backend/plugins/highcharts/js/highcharts-more.js?q=' . time()) }}"></script>
    <script src="{{ asset('backend/plugins/highcharts/js/variable-pie.js?q=' . time()) }}"></script>

    <script src="{{ asset('backend/plugins/highcharts/js/solid-gauge.js?q=' . time()) }}"></script>
    <script src="{{ asset('backend/plugins/highcharts/js/highcharts-3d.js?q=' . time()) }}"></script>
    <script src="{{ asset('backend/plugins/highcharts/js/cylinder.js?q=' . time()) }}"></script>
    <script src="{{ asset('backend/plugins/highcharts/js/funnel3d.js?q=' . time()) }}"></script>
    <script src="{{ asset('backend/plugins/highcharts/js/exporting.js?q=' . time()) }}"></script>
    <script src="{{ asset('backend/plugins/highcharts/js/export-data.js?q=' . time()) }}"></script>
    <script src="{{ asset('backend/plugins/highcharts/js/accessibility.js?q=' . time()) }}"></script>
    <script src="{{ asset('backend/js/index4.js?q=' . time()) }}"></script>
@endsection
