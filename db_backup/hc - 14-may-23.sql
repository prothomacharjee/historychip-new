...
-- Dumping data for table historychip_new.partner_images: ~2 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `stories` (
  ...
  `sub_category_id_level_1` bigint unsigned DEFAULT NULL,
  ...
  `audio_credit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video_credit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dumping data for table historychip_new.story_categories: ~0 rows (approximately)
